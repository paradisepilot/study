...
\textbf{Comments:}
%\begin{itemize}
%\item	The Pohlig-Hellman Algorithm efficiently solves the Discrete Logarithm Problem for $G = \F_{p}^{*}$, where $p$ is a prime number,
%		and $p - 1 = \vert\,\F_{p}^{*}\,\vert = \vert\,G\,\vert$ is the product of small primes. 
%\end{itemize}
