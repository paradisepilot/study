...
\rhead[Exercises]{Kenneth Chu}
\lhead[Kenneth Chu]{Exercises}
\chead[]{{\Large\bf Rotman, Introduction to Homological Algebra (Springer, 2009)} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
%\clearpage
\input{z-Rotman-2009-exercises-Chap01}

%\clearpage
\input{z-Rotman-2009-exercises-Chap02}

%\clearpage
\input{z-Rotman-2009-exercises-Chap03}

%\clearpage
\input{z-Rotman-2009-exercises-Chap04}

\clearpage
\input{z-Rotman-2009-exercises-Chap05}
