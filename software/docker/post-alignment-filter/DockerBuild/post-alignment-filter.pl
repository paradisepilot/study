...
use Getopt::Long;
use Data::Dumper;
#use lib "/u/kchu/mcf7mirna_resources/code/trunk/src/utils/Perl/perl-modules";
#use lib "/home/kchu/kchuhn1/research/svnrepository/BoutrosLab/Collaborators/BradWouters/microRNA-MCF7/Resources/code/trunk/src/utils/Perl/perl-modules";
use SAMAlignment;
use CIGAR;
